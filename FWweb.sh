...
# Allowing Client Web Access and Server
iptables -A INPUT -p tcp --sport 80 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT
iptables -A OUTPUT -p tcp --dport 80 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT

iptables -A INPUT -p tcp --sport 3000 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT
...
iptables -A INPUT -p tcp --dport 9418 -m conntrack --ctstate ESTABLISHED -j ACCEPT 
iptables -A OUTPUT -p tcp --sport 9418 -m conntrack --ctstate NEW,ESTABLISHED -j ACCEPT

# Allowing SMTP Client Access
iptables -A INPUT -p tcp --dport 25 -m conntrack --ctstate ESTABLISHED -j ACCEPT
